...
async def greeting(message: types.Message, state: FSMContext):
    ...
    try:
        ...
        greeting_post = f"{from_user_name}, Вас приветствует чат-бот"
        keyboards_greeting = create_greeting_keyboard()  # Клавиатуры поста приветствия 👋
        await message.answer(greeting_post, reply_markup=keyboards_greeting, parse_mode=types.ParseMode.HTML)  # Текст в HTML-разметки
